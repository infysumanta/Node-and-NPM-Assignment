...
console.log(
  "Subtracting 7 months: " + moment().subtract(7, "months").calendar()
);
...
console.log(
  "Using flattenDeep method: " + lodash.flattenDeep([1, [2, [3, [4]], 5]])
);
console.log(
  "Using chunk method: " +
    lodash.chunk(
...
//Collection Methods
console.log(
  "Using countBy method: " + lodash.countBy([6.1, 4.2, 6.3], Math.floor)
);
console.log("Using includes method: " + lodash.includes([1, 2, 3], 1));
console.log(
  "Using invokeMap method: " +
    lodash.invokeMap(
      [
        [5, 1, 7],
        [3, 2, 1],
